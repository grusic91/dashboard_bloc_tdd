...
dynamic main() {
  ...
  group('updateUser', () {
    ...
    test(
        'should update user displatyname successfully whne no [Exceptions] '
        'is thrown.', () async {
      when(
    ...
    test(
      ...
      verify(
        () => mockUser.verifyBeforeUpdateEmail(tEmail),
      ).called(1);
    ...
    test(
        'should updates user password successfully when no [Exception] '
        'is thrown', () async {
      when(
