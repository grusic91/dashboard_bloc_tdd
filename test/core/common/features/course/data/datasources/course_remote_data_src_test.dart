...
void main() {
  late CourseRemotDataSrc remoteDataSource;
  ...
  group('getCourses', () {
    test('should return a List<Course> when successfull', () async {
      final fistDate = DateTime.now();
      final secondDate = DateTime.now().add(const Duration(seconds: 20));
      final expectedCourses = [
        CourseModel.empty().copyWith(createdAt: fistDate),
